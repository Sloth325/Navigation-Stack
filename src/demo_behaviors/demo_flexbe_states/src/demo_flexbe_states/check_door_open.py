...
class check_door_open(EventState):
    '''
    ...
    def __init__(self):
        ...
        super(check_door_open, self).__init__(outcomes=['open', 'close'])

        self.positivelist = ["是的", "对", "嗯", "打开了", "open", "yes"]
    ...
    def execute(self, userdata):
        # TEXT="请问门打开了吗？"
        TEXT = "Is the door open? Open it please!"
        breakpoint()
