...
class asking_to_press_button(EventState):
    '''
    ...
    def __init__(self, floor):
        ...
        super(asking_to_press_button, self).__init__(outcomes=['accepted', 'refused', 'unclear'])
    ...
    def execute(self, userdata):
        self._floor = floor
        print(self._floor)
        TEXT = "can you press" + str(self._floor) + "floor for me"
        # TEXT="你好，可以帮我把门打开吗？"
