...
from across_door.set_goal import go_across_door


class passing_door(EventState):
    '''
    ...
    def __init__(self):
        ...
        super(passing_door, self).__init__(outcomes=['done'])

        self.positivelist = ["是的", "对", "嗯", "打开了"]
        self.negativelist = ["不是", "不对", "错", "没有"]
    ...
    def execute(self, userdata):
        # TEXT="行进中，请注意避让！"
        TEXT = "Passing,be careful guy, move away!"
